    ...
    <div style={{ background: C.paper, color: C.ink }}
        ...
        <div className="flex items-end justify-between gap-4 flex-wrap">
          <div>
            <div style={{ color: C.violet, letterSpacing: "0.2em" }}
              ...
              Project Log
              <span style={{ color: C.faint, letterSpacing: "normal" }} className="ml-2 font-normal normal-case">build 09-01·per-type</span>
            </div>
      ...
      {showAdd && (
        <AddMeeting
          ...
          onApply={(updates, mtype, date, transcript, reports) => {
          ...
          {preview && (
            <>
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => onApply(preview, effMtype, effDate, effTx, effReports)}
                  style={{ background: C.violet }}
